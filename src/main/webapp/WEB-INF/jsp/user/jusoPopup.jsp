...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIzMTAxOTEzNTUzNDExNDE4ODE=";//승인키
...
<body onload="init();">
	<form id="form" name="form" method="post">
		<input type="hidden" id="confmKey" name="confmKey" value="devU01TX0FVVEgyMDIzMTAxOTEzNTUzNDExNDE4ODE="/>
