...
SELECT 
    A.ACCOUNT_SEQ,
    PC.COM_KOR as PROFIT_COST_NAME,
    BG.COM_KOR as BIG_GROUP_NAME,
    MG.COM_KOR as MIDDLE_GROUP_NAME,
    SG.COM_KOR as SMALL_GROUP_NAME,
    DG.COM_KOR as DETAIL_GROUP_NAME,
    A.COMMENTS,
    A.TRANSACTION_MONEY,
    A.TRANSACTION_DATE,
    A.WRITER,
...
CREATE SEQUENCE ACCOUNT_SEQ_SEQ
  START WITH 1
  INCREMENT BY 1;
